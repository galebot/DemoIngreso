...
const persona1: Cl_persona = new Cl_persona("Mary",150);
const persona2: Cl_persona = new Cl_persona("Jose",135);
const persona3: Cl_persona = new Cl_persona("Carlos",160);
const persona4: Cl_persona = new Cl_persona("Pedro",75);
const ingreso: Cl_ingreso = new Cl_ingreso();
